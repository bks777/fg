import BonusResumePopup from "../../../../CommonComponents/BonusGame/viewHandler/bonusResumePopup/bonusResumePopup";
import config from "./config";

export default class BonusResumeMobilePopup extends BonusResumePopup {
