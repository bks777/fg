 ...
 * @constructor
 */
export default class winMobileViewHandler extends winCommonViewHandler {
    ...
    setQuickEndAnimation(){
        this.getCanvas().removeEventListener('touchstart', this.bindedQS);
        if(this.isQuickStop) {
            return;
        }
    ...
    showBigWin(resolveMain = null, type = false){
        ...
        this.getHandler('control').getLayout().visible = false;
        this._winCounter = {};
        ...
        this.getCanvas().addEventListener("touchstart", this.bindedQS);
    ...
    _clearAnimations(resolveMain){
        ...
        this.getCanvas().removeEventListener('touchstart', this.bindedQS);
        this.getHandler('control').getLayout().visible = true;
    }
